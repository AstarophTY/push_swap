...
NAME := push_swap
BASE_NAME := main create_list parsing parsing_utils push swap rotate algorithme radix_sort bubble_sort utils chunk_sort chunk_utils selection_sort bench
...
CFLAGS := -g3 # Retirer le g3 a la fin -Wall -Werror -Wextra
